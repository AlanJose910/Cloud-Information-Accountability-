...
public partial class Admin_AlfilesCloud1 : System.Web.UI.Page
{
    ...
    public static int CountC1 = 0, CountCPDP = 0, C1 = 0;
    ...
    protected void AllFileDetails()
    {
        ...
        for (int j = 0; j < CountC1; j++)
        {
            string SELECT_SQL = "select UserRegistration.Ownername,Filearchieve.fsubject,Filearchieve.fsizeinkb, " +
                         ...
                         " UserRegistration,Filearchieve where UserRegistration.OwnerID=Filearchieve.fowner and Filearchieve.Fid=" + ArrLst_C1[j].ToString();
